...
cp "$project_directory/app/sql_guard.py" "$payload_directory/app/"
cp "$project_directory/app/schema_grounding.py" "$payload_directory/app/"
...
cp "$project_directory/Info.plist" "$app_bundle/Contents/"
cp "$project_directory/diad.icns" "$app_bundle/Contents/Resources/diad.icns"
#copies over Plist
